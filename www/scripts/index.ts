...
let loginmusicmp3 = new Audio('music/loginmusic.mp3');
...
let errormp3 = new Audio('music/error.mp3');
let successmp3 = new Audio('music/success.mp3');
let logoutmp3 = new Audio('music/logout.mp3');
let techeffectmp3 = new Audio('music/techeffect.mp3');
...
let timeoutscanning;
let systemIsScanning: boolean = false;

// ---------------------------------------------------------------------------------------------------------------------
// ------------------------------ SCHERMATA 1 : LOGIN ------------------------------------------------------------------
// ---------------------------------------------------------------------------------------------------------------------

function startApp() { // Inizio l'app
//
    playlogin();
//
//
...
let globalImplantAccess = true; // Usando Firebase non c'è piu distinzione tra utenti Admin e Normali, per ora l'accesso a tutti gli impianti rimane True SEMPRE

$(document).on('click', '#divloginpro', function () {


    let username = $("#textareauser").val();
    let password = $("#textareapassword").val();
...
function clearEverything() { // Resetta alla grafica di default gli input quando li metto in focus (tolgo il rosso)
...
$(document).on('click', '#showhidepassword', function () {
    ...
    let currentOpacity: any = $('.showhidepasswordimg').css('opacity'); // Faccio any cosi non mi da errori strani

    let textareapassword: any = document.getElementById('textareapassword'); // Mi tocca fare cosi (dare any a una variabile) quasi sempre perchè TS da errori
...
$(document).on('click', '#updatemusic', function () {
    ...
    if (musicActive == 'false') {
        ...
        setTimeout(function () { // Parte dopo 100 ms sennò non sento il suono attivo / disattivo
